...
<div class="width1198 center_yh" style="height: 35px;background: #f0f0f0; border: 1px solid #ddd;margin-top:25px;">
    <a href="${ctx}/item/shoplist?category_id_two=${obj.category_id_two}" class="mR">默认</a>
    <a href="${ctx}/item/shoplist?price=1&category_id_two=${obj.category_id_two}" class="mR">
        价格
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
    <a href="${ctx}/item/shoplist?gmNum=1&category_id_two=${obj.category_id_two}" class="mR">
        销量
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
    ...
    <ul class="listSs">
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <li>
                ...
                <div class="wCa">
                    <a href="${ctx}/sc/exAdd?item_id=${data.id}" class="fav">
                        <div class="wCa1">
...
<div id="navs">
    <div class="pagelist">
        ...
        <pg:pager url="${ctx}/item/shoplist" maxIndexPages="5" items="${pagers.total}" maxPageItems="15" export="curPage=pageNumber">
            <pg:param name="category_id_two" value="${obj.category_id_two}"/>
